...
To copy the database on your local computer you would download the dumpfile in the repository located at **Group3/StudyBuddy.sql** then run on your local sql software.
